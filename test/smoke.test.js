...
console.log('\n[student-community.html]');
{
  ...
  const pillars = [...d.querySelectorAll('#student-innovation .cards--4 .card h3')].map(h => h.textContent);
  ok(JSON.stringify(pillars) === JSON.stringify(['Student Innovation', 'Research & Innovation', 'Student Leadership', 'Global Collaboration']), 'four pillars: Innovation / Research / Leadership / Global');
