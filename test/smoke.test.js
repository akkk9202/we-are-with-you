...
console.log('\n[student-community.html]');
{
  ...
  const cards4 = [...d.querySelectorAll('.cards--4 .card h3')].map(h => h.textContent);
  ok(JSON.stringify(cards4) === JSON.stringify(['Learn', 'Create', 'Serve', 'Lead']), 'four cards: Learn / Create / Serve / Lead');
