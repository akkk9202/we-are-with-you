...
const PARTNERS = {
  ...
  "cancer-care": {
    ...
    cardText: "Music, letters, and song requests for patients, caregivers, survivors, and staff.",
  ...
  "nicu": {
    ...
    cardText: "Quiet music and letters for NICU parents, families, and care teams.",
  ...
  "senior-living": {
    ...
    cardText: "Performances, familiar songs, and visits with residents and their families.",
